/**
 * @file   gpio_test.c
 * @author Thad Hughes (Originally Derek Molloy)
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Thad Hughes");
MODULE_DESCRIPTION("A Button/LED test driver for the BBB");
MODULE_VERSION("0.1");

static unsigned int gpioLED = 32 + 19;       ///< hard coding the LED gpio for this example to P9_16
static unsigned int gpioButton = 32 + 16;   ///< hard coding the button gpio for this example to P9_15
...
static irq_handler_t ebbgpio_irq_handler(unsigned int irq, void *dev_id, struct pt_regs *regs){
   ...
   if (ledOn) numberPresses++;                         // Global counter, will be outputted when the module is unloaded
